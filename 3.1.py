...
input_label = tk.Label(root, text="Enter temperature", background='#F18C8E', foreground="#FFFFFF")
...
result_label1 = tk.Label(root, background='#F18C8E', foreground="#FFFFFF")
result_label1.grid(row=3, columnspan=4)
result_label2 = tk.Label(root, background='#F18C8E', foreground="#FFFFFF")
...
dropdown.config(background='#F18C8E', foreground="#FFFFFF")
dropdown["menu"].config(background='#F18C8E', foreground="#FFFFFF")
# button click
call_convert = partial(call_convert, result_label1, result_label2, numberInput)
result_button = tk.Button(root, text="Convert", command=call_convert, background='#F18C8E', foreground="#FFFFFF")
